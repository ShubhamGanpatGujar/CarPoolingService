        ...
        try (PrintWriter out = response.getWriter()) {
         ...
         String managerEmail;
             String managerPassword; 
              managerEmail = request.getParameter("managerEmail");
           managerPassword = request.getParameter("managerPassword");
           ManagerDAO managerDAO = new ManagerDAOImpl();
            RequestDispatcher rd = null;
            if(managerDAO.isUserValid(managerEmail, managerPassword)){
                HttpSession session = request.getSession();
                session.setAttribute("loginid", managerEmail);
                rd = request.getRequestDispatcher("HomeM.jsp");
               
            }
            else{
                rd = request.getRequestDispatcher("ManagerSignIn.jsp");
            }
