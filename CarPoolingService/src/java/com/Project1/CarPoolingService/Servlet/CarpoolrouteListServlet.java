 ...
 * @author SHUBHAM
 */
public class CarpoolrouteListServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           List<CarPoolRoute> carpoolrouteList= carpoolrouteDAO.getAllCarPoolRoute();
            System.out.println("No of Records " + carpoolrouteList.size());
            if(carpoolrouteList.size()>0){
                request.setAttribute("carpoolrouteList", carpoolrouteList);
                RequestDispatcher rd = request.getRequestDispatcher("CarpoolrouteList.jsp");
