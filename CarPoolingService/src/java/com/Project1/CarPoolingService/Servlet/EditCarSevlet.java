 ...
 * @author SHUBHAM
 */
public class EditCarSevlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            carID = Integer.parseInt(request.getParameter("carID").trim());
            ...
            carAC= request.getParameter("carAC");
             carSeating=Integer.parseInt(request.getParameter("carSeating"));
              count = carDAO.updateCar(carID,new Car(carNo,carModel,carAC,carSeating));
                }
            ...
            if(count>0){
               rd = request.getRequestDispatcher("CarList.view");
                ...
                rd = request.getRequestDispatcher("CarList.jsp?carID="+carID);
            }
